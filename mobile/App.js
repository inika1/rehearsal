...
const s = StyleSheet.create({
  ...
  addnew: { marginHorizontal: 20, marginTop: 12, marginBottom: 20,
    paddingVertical: SW * 0.048, paddingHorizontal: 16, backgroundColor: '#ffffff',
    borderRadius: 16, borderWidth: 1, borderColor: '#e5e7eb', alignItems: 'center',
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 4, shadowOffset: { width: 0, height: 1 } },
  addnewTx: { color: 'rgba(0,0,0,.5)', fontSize: 17, fontWeight: '500' },
  ...
  ta: { backgroundColor: '#f9fafb', borderWidth: 1, borderColor: '#e5e7eb',
    borderRadius: 14, padding: 14, minHeight: SW * 0.22, color: '#111827', fontSize: 14, lineHeight: 22 },
  prev: { marginTop: 'auto', paddingVertical: SW * 0.042, paddingHorizontal: 14,
    backgroundColor: '#f9fafb', borderRadius: 14, borderWidth: 1, borderColor: '#e5e7eb' },
  prevTx: { color: 'rgba(0,0,0,.5)', fontSize: 15, fontWeight: '500', textAlign: 'center' },
  callbtnHalo: { alignSelf: 'center', marginTop: 12, marginBottom: 6, width: 116, height: 116,
  ...
  // Delete buttons
  deleteContact: { marginTop: 10, paddingVertical: 16, paddingHorizontal: SW * 0.08,
  ...
  deleteConvBtn: { marginHorizontal: 24, marginTop: 20, marginBottom: 4,
    paddingVertical: 16, paddingHorizontal: SW * 0.08,
